...
const Sustainability: React.FC = () => {
  const initiatives = [
    {
      ...
      description: 'Advanced water recycling systems reduce consumption by 60%',
      impact: '2.5M liters saved annually'
    },
    {
      icon: Recycle,
      title: 'Waste Reduction',
      description: 'Zero-waste manufacturing with 95% material utilization',
      impact: '500 tons diverted from landfills'
    },
    {
      icon: Sun,
      title: 'Renewable Energy',
      description: 'Solar power systems provide 40% of our energy needs',
      impact: '1,200 MWh clean energy annually'
    },
    {
      icon: Heart,
      title: 'Community Impact',
      description: 'Local community development and education programs',
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative py-32 bg-gradient-to-r from-green-600 to-primary">
        <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Leading the industry in sustainable practices and environmental stewardship
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {initiatives.map((initiative, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <initiative.icon className="w-12 h-12 text-primary mb-6" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-gray-600">Water Usage Reduction</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Material Utilization</div>
            </div>
          </div>
        </div>
      </section>
